...
<div class="page-header">
    ...
    <div class="page-header-right ms-auto">
        <a href="{{ route('organization.index') }}" class="btn btn-light-brand btn-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <!-- Restore -->
                                    <a href="{{ route('organization.restore', $organization->id) }}"
                                    ...
                                    <!-- Permanent Delete -->
                                    <form action="{{ route('organization.forceDelete', $organization->id) }}"
                                          method="POST"
